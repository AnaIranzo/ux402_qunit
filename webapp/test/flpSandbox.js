		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Unit Tests",
									"targetURL": "#student6820comsaptrainingux402qunitux402qunit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student6820comsaptrainingux402qunitux402qunit-display": {
								"semanticObject": "student6820comsaptrainingux402qunitux402qunit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student6820.com.sap.training.ux402.qunit.ux402qunit",
									"url": sap.ui.require.toUrl("student6820/com/sap/training/ux402/qunit/ux402qunit")
								}
							}
						}
					}
